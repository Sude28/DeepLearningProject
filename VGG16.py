...
plt.title('VGG16 Doğruluk Grafiği'); plt.xlabel('Epoch'); plt.ylabel('Doğruluk'); plt.grid(); plt.legend()
...
plt.title('VGG16 Kayıp Grafiği'); plt.xlabel('Epoch'); plt.ylabel('Kayıp'); plt.grid(); plt.legend()
plt.tight_layout()
